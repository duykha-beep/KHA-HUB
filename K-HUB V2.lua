-- discord.gg/khaduytarn


shared.LoaderTitle = "Theo dõi phở bỏ của admin nha";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://108330022885187",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=108330022885187";
v24.Parent = v23;
...
v16.Home:AddButton({
    Title = "phở Bò Admin",
    Description = "chưa có người yêu",
    Callback = function()
        setclipboard("https://www.facebook.com/share/1BQFr4jwaQ/");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://108330022885187") then
                    return v729;
                end
            end
        end
